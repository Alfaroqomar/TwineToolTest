...
import {
  clsx_m_default,
  init_clsx_m
} from "./chunk-E3IFCK56.js";
import {
  require_prop_types
} from "./chunk-3CNKWSD5.js";
import {
  require_react
...
function deepMap(children, callback) {
  return import_react.Children.map(children, function(child) {
    ...
    if (child.props && child.props.children && typeof child.props.children === "object") {
      return (0, import_react.cloneElement)(child, _extends({}, child.props, {
...
var propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  direction: import_prop_types.default.oneOf(["rtl", "ltr"]),
  className: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.array, import_prop_types.default.object]),
  disabledTabClassName: import_prop_types.default.string,
  disableUpDownKeys: import_prop_types.default.bool,
  domRef: import_prop_types.default.func,
  focus: import_prop_types.default.bool,
  forceRenderTabPanel: import_prop_types.default.bool,
  onSelect: import_prop_types.default.func.isRequired,
  selectedIndex: import_prop_types.default.number.isRequired,
  selectedTabClassName: import_prop_types.default.string,
  selectedTabPanelClassName: import_prop_types.default.string,
  environment: import_prop_types.default.object
} : {};
var UncontrolledTabs = function UncontrolledTabs2(props) {
  ...
  var panelIds = (0, import_react2.useRef)([]);
  ...
  function getChildren() {
    ...
    return deepMap(children2, function(child) {
      ...
      if (isTabList(child)) {
        ...
        result = (0, import_react2.cloneElement)(child, {
          children: deepMap(child.props.children, function(tab) {
            ...
            var props2 = {
              ...
              selected,
              focus: selected && (focus2 || wasTabFocused)
            };
        ...
        if (forceRenderTabPanel2) _props.forceRender = forceRenderTabPanel2;
        if (selectedTabPanelClassName2) _props.selectedClassName = selectedTabPanelClassName2;
        index++;
  ...
  return import_react2.default.createElement("div", _extends2({}, attributes, {
...
var propTypes2 = process.env.NODE_ENV !== "production" ? {
  children: childrenPropType,
  className: import_prop_types2.default.oneOfType([import_prop_types2.default.string, import_prop_types2.default.array, import_prop_types2.default.object]),
  defaultFocus: import_prop_types2.default.bool,
  defaultIndex: import_prop_types2.default.number,
  direction: import_prop_types2.default.oneOf(["rtl", "ltr"]),
  disabledTabClassName: import_prop_types2.default.string,
  disableUpDownKeys: import_prop_types2.default.bool,
  domRef: import_prop_types2.default.func,
  environment: import_prop_types2.default.object,
  focusTabOnClick: import_prop_types2.default.bool,
  forceRenderTabPanel: import_prop_types2.default.bool,
  onSelect: onSelectPropType,
  selectedIndex: selectedIndexPropType,
  selectedTabClassName: import_prop_types2.default.string,
  selectedTabPanelClassName: import_prop_types2.default.string
} : {};
var defaultProps2 = {
  defaultFocus: false,
...
var checkForIllegalModeChange = function checkForIllegalModeChange2(props, mode) {
  if (process.env.NODE_ENV !== "production" && mode != void 0 && mode !== getModeFromProps(props)) {
...
Tabs.propTypes = process.env.NODE_ENV !== "production" ? propTypes2 : {};
...
var propTypes3 = process.env.NODE_ENV !== "production" ? {
  children: import_prop_types3.default.oneOfType([import_prop_types3.default.object, import_prop_types3.default.array]),
  className: import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.array, import_prop_types3.default.object])
} : {};
var TabList = function TabList2(props) {
  ...
  return import_react4.default.createElement("ul", _extends4({}, attributes, {
    className: clsx_m_default(className),
    role: "tablist"
  }), children);
};
TabList.tabsRole = "TabList";
TabList.propTypes = process.env.NODE_ENV !== "production" ? propTypes3 : {};
...
init_clsx_m();
var _excluded3 = ["children", "className", "disabled", "disabledClassName", "focus", "id", "panelId", "selected", "selectedClassName", "tabIndex", "tabRef"];
function _extends5() {
...
var propTypes4 = process.env.NODE_ENV !== "production" ? {
  children: import_prop_types4.default.oneOfType([import_prop_types4.default.array, import_prop_types4.default.object, import_prop_types4.default.string]),
  className: import_prop_types4.default.oneOfType([import_prop_types4.default.string, import_prop_types4.default.array, import_prop_types4.default.object]),
  disabled: import_prop_types4.default.bool,
  disabledClassName: import_prop_types4.default.string,
  focus: import_prop_types4.default.bool,
  // private
  id: import_prop_types4.default.string,
  // private
  panelId: import_prop_types4.default.string,
  // private
  selected: import_prop_types4.default.bool,
  // private
  selectedClassName: import_prop_types4.default.string,
  tabIndex: import_prop_types4.default.string,
  tabRef: import_prop_types4.default.func
  // private
} : {};
var Tab = function Tab2(props) {
  var _cx;
  var nodeRef = (0, import_react5.useRef)();
  var children = props.children, className = props.className, disabled = props.disabled, disabledClassName = props.disabledClassName, focus = props.focus, id = props.id, panelId = props.panelId, selected = props.selected, selectedClassName = props.selectedClassName, tabIndex = props.tabIndex, tabRef = props.tabRef, attributes = _objectWithoutPropertiesLoose3(props, _excluded3);
  (0, import_react5.useEffect)(function() {
    if (selected && focus) {
      nodeRef.current.focus();
    }
  }, [selected, focus]);
  return import_react5.default.createElement("li", _extends5({}, attributes, {
    className: clsx_m_default(className, (_cx = {}, _cx[selectedClassName] = selected, _cx[disabledClassName] = disabled, _cx)),
    ref: function ref(node) {
...
Tab.propTypes = process.env.NODE_ENV !== "production" ? propTypes4 : {};
Tab.tabsRole = "Tab";
...
init_clsx_m();
var _excluded4 = ["children", "className", "forceRender", "id", "selected", "selectedClassName", "tabId"];
function _extends6() {
...
var defaultProps4 = {
  className: DEFAULT_CLASS2,
  forceRender: false,
  selectedClassName: DEFAULT_CLASS2 + "--selected"
};
var propTypes5 = process.env.NODE_ENV !== "production" ? {
  children: import_prop_types5.default.node,
  className: import_prop_types5.default.oneOfType([import_prop_types5.default.string, import_prop_types5.default.array, import_prop_types5.default.object]),
  forceRender: import_prop_types5.default.bool,
  id: import_prop_types5.default.string,
  // private
  selected: import_prop_types5.default.bool,
  // private
  selectedClassName: import_prop_types5.default.string,
  tabId: import_prop_types5.default.string
  // private
} : {};
var TabPanel = function TabPanel2(props) {
  var _cx;
  var children = props.children, className = props.className, forceRender = props.forceRender, id = props.id, selected = props.selected, selectedClassName = props.selectedClassName, tabId = props.tabId, attributes = _objectWithoutPropertiesLoose4(props, _excluded4);
  return import_react6.default.createElement("div", _extends6({}, attributes, {
    className: clsx_m_default(className, (_cx = {}, _cx[selectedClassName] = selected, _cx)),
    role: "tabpanel",
    id,
...
TabPanel.propTypes = process.env.NODE_ENV !== "production" ? propTypes5 : {};
TabPanel.defaultProps = defaultProps4;
