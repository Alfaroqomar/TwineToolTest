...
import {
  _extends,
  _inheritsLoose
} from "./chunk-KOLZVOAQ.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-YCN3JA6U.js";
import {
  require_prop_types
} from "./chunk-3CNKWSD5.js";
import "./chunk-2ZGRD42A.js";
import {
  require_react
...
var require_react_is_production_min = __commonJS({
  "node_modules/react-router/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
    "use strict";
    var import_dist25 = __toESM(require_dist());
    var import_dist26 = __toESM(require_dist2());
    var import_dist27 = __toESM(require_dist3());
    ...
    _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
      if (this.props.value !== nextProps.value) {
        ...
        if (objectIs(oldValue, newValue)) {
          ...
          if (process.env.NODE_ENV !== "production") {
            process.env.NODE_ENV !== "production" ? tiny_warning_esm_default((changedBits & MAX_SIGNED_31_BIT_INT) === changedBits, "calculateChangedBits: Expected the return value to be a 31-bit integer. Instead received: " + changedBits) : void 0;
          }
          changedBits |= 0;
          if (changedBits !== 0) {
...
function Prompt(_ref) {
  ...
  return import_react.default.createElement(context.Consumer, null, function(context2) {
    !context2 ? process.env.NODE_ENV !== "production" ? invariant(false, "You should not use <Prompt> outside a <Router>") : invariant(false) : void 0;
...
var Route = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react.default.createElement(context.Consumer, null, function(context$1) {
      ...
      return import_react.default.createElement(context.Provider, {
        value: props
      }, props.match ? children ? typeof children === "function" ? process.env.NODE_ENV !== "production" ? evalChildrenDev(children, props, _this.props.path) : children(props) : children : component ? import_react.default.createElement(component, props) : render2 ? render2(props) : null : typeof children === "function" ? process.env.NODE_ENV !== "production" ? evalChildrenDev(children, props, _this.props.path) : children(props) : null);
    });
  };
  return Route2;
}(import_react.default.Component);
...
function withRouter(Component) {
  ...
  var C = function C2(props) {
    ...
    return import_react.default.createElement(context.Consumer, null, function(context2) {
      !context2 ? process.env.NODE_ENV !== "production" ? invariant(false, "You should not use <" + displayName + " /> outside a <Router>") : invariant(false) : void 0;
...
function createBrowserHistory(props) {
  ...
  !canUseDOM2 ? process.env.NODE_ENV !== "production" ? invariant(false, "Browser history needs a DOM") : invariant(false) : void 0;
  ...
  function getDOMLocation(historyState) {
    ...
    if (basename) path = stripBasename2(path, basename);
...
function createHashHistory(props) {
  ...
  !canUseDOM2 ? process.env.NODE_ENV !== "production" ? invariant(false, "Hash history needs a DOM") : invariant(false) : void 0;
  var globalHistory = window.history;
  ...
  function getDOMLocation() {
    ...
    if (basename) path2 = stripBasename2(path2, basename);
  ...
  function handleHashChange() {
    ...
    if (path2 !== encodedPath2) {
      ...
      if (ignorePath === createPath2(location)) return;
      ignorePath = null;
      handlePop(location);
    }
  }
